...
struct e1000_host_mng_command_info {
	...
	u8 command_data
		[E1000_HI_MAX_MNG_DATA_LENGTH]; /* Command data can length 0..0x658 */
};
#ifdef __BIG_ENDIAN
...
#define IMS_ENABLE_MASK                                       \
	(E1000_IMS_RXT0 | E1000_IMS_TXDW | E1000_IMS_RXDMT0 | \
...
struct e1000_host_command_info {
	struct e1000_host_command_header
		command_header; /* Command Head/Command Result Head has 4 bytes */
	u8 command_data
		[E1000_HI_MAX_DATA_LENGTH]; /* Command data can length 0..252 */
};
	...
	((adapter)->tbi_compatibility_on &&                                    \
	 ...
	 (((status) & E1000_RXD_STAT_VP) ?                                     \
		  ...
		  (((length) > (adapter)->min_frame_size) &&                   \
		   ((length) <=                                                \
		    ((adapter)->max_frame_size + VLAN_TAG_SIZE + 1)))))
