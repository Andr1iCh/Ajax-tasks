...
struct e1000_host_mng_command_info {
  ...
  u8 command_data[E1000_HI_MAX_MNG_DATA_LENGTH]; /* Command data can length
                                                    0..0x658 */
};
#ifdef __BIG_ENDIAN
...
#define E1000_ICRXPTC                                     \
  0x04104 /* Interrupt Cause Rx Packet Timer Expire Count \
           */
#define E1000_ICRXATC \
  0x04108 /* Interrupt Cause Rx Absolute Timer Expire Count */
#define E1000_ICTXPTC                                     \
  0x0410C /* Interrupt Cause Tx Packet Timer Expire Count \
           */
#define E1000_ICTXATC \
  0x04110 /* Interrupt Cause Tx Absolute Timer Expire Count */
#define E1000_ICTXQEC 0x04118 /* Interrupt Cause Tx Queue Empty Count */
#define E1000_ICTXQMTC \
  0x0411C /* Interrupt Cause Tx Queue Minimum Threshold Count */
#define E1000_ICRXDMTC \
  0x04120 /* Interrupt Cause Rx Descriptor Minimum Threshold Count */
...
#define E1000_82542_SRRCTL(_n)                    \
  (0x280C + ((_n) << 8)) /* Split and Replication \
                          * RX Control - RW */
...
#define E1000_EEPROM_RW_REG_DATA \
  16 /* Offset to data in EEPROM read/write registers */
#define E1000_EEPROM_RW_REG_DONE 2 /* Offset to READ/WRITE done bit */
#define E1000_EEPROM_RW_REG_START \
  1 /* First bit for telling part to start operation */
...
#define E1000_CTRL_GIO_MASTER_DISABLE                               \
  0x00000004                           /*Blocks new Master requests \
                                        */
...
#define E1000_CTRL_D_UD_POLARITY \
  0x00004000 /* Defined polarity of Dock/Undock indication in SDP[0] */
#define E1000_CTRL_FORCE_PHY_RESET \
  0x00008000 /* Reset both PHY ports, through PHYRST_N pin */
#define E1000_CTRL_EXT_LINK_EN \
  0x00010000 /* enable link status from external LINK_0 and LINK_1 pins */
...
#define E1000_CTRL_SW2FW_INT \
  0x02000000 /* Initiate an interrupt to manageability engine */
...
#define E1000_STATUS_LAN_INIT_DONE                          \
  0x00000200                         /* Lan Init Completion \
                                                                     by EEPROM/Flash */
#define E1000_STATUS_ASDV 0x00000300 /* Auto speed detect value */
#define E1000_STATUS_DOCK_CI \
  0x00000800 /* Change in Dock/Undock state. Clear on write '0'. */
#define E1000_STATUS_GIO_MASTER_ENABLE \
  0x00080000                               /* Status of Master requests. */
...
#define E1000_STATUS_BMC_LITE \
  0x01000000 /* BMC external code execution disabled */
...
#define E1000_STATUS_PCIX_SPEED_100         \
  0x00004000 /* PCI-X bus speed  66-100 MHz \
              */
#define E1000_STATUS_PCIX_SPEED_133         \
  0x00008000 /* PCI-X bus speed 100-133 MHz \
              */
...
#define E1000_EECD_ADDR_BITS                                               \
  0x00000400                       /* EEPROM Addressing bits based on type \
                                    * (0-small, 1-large) */
...
#define E1000_CTRL_EXT_INT_TIMER_CLR \
  0x20000000 /* Clear Interrupt timers after IMS clear */
#define E1000_CRTL_EXT_PB_PAREN \
  0x01000000 /* packet buffer parity error detection enabled */
#define E1000_CTRL_EXT_DF_PAREN \
  0x02000000 /* descriptor FIFO parity error detection enable */
...
#define E1000_TXDCTL_COUNT_DESC              \
  0x00400000 /* Enable the counting of desc. \
...
#define E1000_WUFC_FLX_FILTERS                  \
  0x000F0000 /* Mask for the 4 flexible filters \
              */
...
#define E1000_MANC_NEIGHBOR_EN                                           \
  0x00004000                                /* Enable Neighbor Discovery \
                                             * Filtering */
...
#define E1000_MANC_EN_MAC_ADDR_FILTER \
  0x00100000 /* Enable MAC address    \
              * filtering */
#define E1000_MANC_EN_MNG2HOST             \
  0x00200000 /* Enable MNG packets to host \
              * memory */
#define E1000_MANC_EN_IP_ADDR_FILTER                              \
  0x00400000                                 /* Enable IP address \
                                              * filtering */
...
#define E1000_HICR_C                                                \
  0x00000002                      /* Driver sets this bit when done \
...
#define EEPROM_SERDES_AMPLITUDE \
  0x0006 /* For SERDES output amplitude adjustment. */
...
#define IGP01E1000_PHY_PORT_CONFIG                                           \
  0x10                                  /* PHY Specific Port Config Register \
                                         */
...
#define NPTX_TOGGLE                   \
  0x0800 /* Toggles between exchanges \
          * of different NP           \
          */
#define NPTX_ACKNOWLDGE2                                   \
  0x1000                     /* 1 = will comply with msg   \
                              * 0 = cannot comply with msg \
                              */
#define NPTX_MSG_PAGE 0x2000 /* formatted(1)/unformatted(0) pg */
#define NPTX_NEXT_PAGE                  \
  0x8000 /* 1 = addition NP will follow \
          * 0 = sending last NP         \
          */
...
#define M88E1000_PSCR_POLARITY_REVERSAL                              \
  0x0002                              /* 1=Polarity Reversal enabled \
                                       */
...
#define M88E1000_PSSR_CABLE_LENGTH                                           \
  0x0380                                       /* 0=<50M;1=50-80M;2=80-110M; \
                                                * 3=110-140M;4=>140M */
...
#define M88E1000_EPSCR_DOWN_NO_IDLE         \
  0x8000 /* 1=Lost lock detect enabled.     \
...
#define IGP3_PHY_PORT_CTRL PHY_REG(769, 17) /* Port General Configuration */
...
#define IGP3_KMRN_DIAG PHY_REG(770, 19)     /* KMRN Diagnostic register */
#define IGP3_KMRN_DIAG_PCS_LOCK_LOSS 0x0002 /* RX PCS is not synced */
#define IGP3_KMRN_ACK_TIMEOUT \
  PHY_REG(770, 20) /* KMRN Acknowledge Timeouts register */

#define IGP3_VR_CTRL PHY_REG(776, 18) /* Voltage regulator control register */
#define IGP3_VR_CTRL_MODE_SHUT 0x0200 /* Enter powerdown, shutdown VRs */
#define IGP3_VR_CTRL_MODE_MASK 0x0300 /* Shutdown VR Mask */

#define IGP3_CAPABILITY PHY_REG(776, 19) /* IGP3 Capability Register */
...
#define IGP3_CAP_AMT_CB \
  0x0200 /* Support active manageability and circuit breaker */
...
#define IFE_PHY_EXTENDED_STATUS_CONTROL \
  0x10 /* 100BaseTx Extended Status, Control and Address */
#define IFE_PHY_SPECIAL_CONTROL \
  0x11 /* 100BaseTx PHY special control register */
#define IFE_PHY_RCV_FALSE_CARRIER \
  0x13 /* 100BaseTx Receive False Carrier Counter */
#define IFE_PHY_RCV_DISCONNECT 0x14 /* 100BaseTx Receive Disconnect Counter */
#define IFE_PHY_RCV_ERROT_FRAME                                              \
  0x15                              /* 100BaseTx Receive Error Frame Counter \
                                     */
#define IFE_PHY_RCV_SYMBOL_ERR 0x16 /* Receive Symbol Error Counter */
#define IFE_PHY_PREM_EOF_ERR \
  0x17 /* 100BaseTx Receive Premature End Of Frame Error Counter */
#define IFE_PHY_RCV_EOF_ERR \
  0x18 /* 10BaseT Receive End Of Frame Error Counter */
#define IFE_PHY_TX_JABBER_DETECT \
  0x19                         /* 10BaseT Transmit Jabber Detect Counter */
#define IFE_PHY_EQUALIZER 0x1A /* PHY Equalizer Control and Status */
#define IFE_PHY_SPECIAL_CONTROL_LED \
  0x1B /* PHY special control and LED configuration */
#define IFE_PHY_MDIX_CONTROL 0x1C /* MDI/MDI-X Control register */
#define IFE_PHY_HWI_CONTROL 0x1D  /* Hardware Integrity Control (HWI) */

#define IFE_PESC_REDUCED_POWER_DOWN_DISABLE \
  0x2000 /* Default 1 = Disable auto reduced power down */
#define IFE_PESC_100BTX_POWER_DOWN \
  0x0400 /* Indicates the power state of 100BASE-TX */
#define IFE_PESC_10BTX_POWER_DOWN \
  0x0200 /* Indicates the power state of 10BASE-T */
#define IFE_PESC_POLARITY_REVERSED 0x0100 /* Indicates 10BASE-T polarity */
#define IFE_PESC_PHY_ADDR_MASK 0x007C     /* Bit 6:2 for sampled PHY address */
#define IFE_PESC_SPEED \
  0x0002 /* Auto-negotiation speed result 1=100Mbs, 0=10Mbs */
#define IFE_PESC_DUPLEX \
  0x0001 /* Auto-negotiation duplex result 1=Full, 0=Half */
#define IFE_PESC_POLARITY_REVERSED_SHIFT 8

#define IFE_PSC_DISABLE_DYNAMIC_POWER_DOWN \
  0x0100                              /* 1 = Dynamic Power Down disabled */
#define IFE_PSC_FORCE_POLARITY 0x0020 /* 1=Reversed Polarity, 0=Normal */
#define IFE_PSC_AUTO_POLARITY_DISABLE \
  0x0010 /* 1=Auto Polarity Disabled, 0=Enabled */
#define IFE_PSC_JABBER_FUNC_DISABLE \
  0x0001 /* 1=Jabber Disabled, 0=Normal Jabber Operation */
#define IFE_PSC_FORCE_POLARITY_SHIFT 5
#define IFE_PSC_AUTO_POLARITY_DISABLE_SHIFT 4

#define IFE_PMC_AUTO_MDIX \
  0x0080 /* 1=enable MDI/MDI-X feature, default 0=disabled */
#define IFE_PMC_FORCE_MDIX 0x0040  /* 1=force MDIX-X, 0=force MDI */
#define IFE_PMC_MDIX_STATUS 0x0020 /* 1=MDI-X, 0=MDI */
#define IFE_PMC_AUTO_MDIX_COMPLETE \
  0x0010 /* Resolution algorithm is completed */
...
#define IFE_PHC_LOW_HIGH_Z_MASK \
  0x0600 /* Mask for indication type of problem on the line */
#define IFE_PHC_DISTANCE_MASK \
  0x01FF /* Mask for distance to the cable problem, in 80cm granularity */
